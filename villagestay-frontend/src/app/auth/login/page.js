...
// Enhanced Advanced Search Component with fixed UI
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-gray-800/90 backdrop-blur-lg rounded-2xl p-2 shadow-lg border border-gray-700 inline-flex">
          {[
            {
              value: "semantic",
              label: "Semantic",
...
const ListingsPage = () => {
 ...
 // NEW: Weekly weather prediction function
   ...
   <Providers>
     <AppLayout>
       <div className="min-h-screen overflow-hidden">
         ...
         {/* Advanced Search Modal - Fixed UI */}
         <AnimatePresence>
           {showAdvancedSearch && (
