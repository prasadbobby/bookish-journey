        ...
        <AppLayout>
          <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center">
            ...
            >
              ...
              <p className="text-gray-600">Welcome back! Taking you to your dashboard</p>
            </motion.div>
          </div>
        </AppLayout>
      </Providers>
              ...
              >
                ...
                <div className="mb-12">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Connect with authentic rural communities and discover the beauty of village life through AI-powered recommendations.
                  </p>
                </div>
                ...
                <div className="space-y-4 mb-12">
                  {[
                    { icon: SparklesIcon, text: "AI-powered village discovery" },
                    { icon: ShieldCheckIcon, text: "Verified local hosts" },
                    { icon: GlobeAltIcon, text: "Cultural immersion experiences" }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="text-left">
                                <div className="font-bold">{account.type} Account</div>
