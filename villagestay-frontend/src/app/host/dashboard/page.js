// src/app/host/dashboard/page.js - Fixed dynamic import
'use client';
  ...
  return (
    <div className="min-h-screen village-bg pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {quickActions.map((action, index) => (
            ...
            >
              {action.href ? (
                ...
                <button onClick={action.onClick} className="group w-full">
                  <div className="card card-hover p-6 text-center h-full">
                    <div className={`w-12 h-12 bg-gradient-to-r ${action.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      <action.icon className="w-6 h-6 text-white" />
                    </div>
        ...
        {/* Recent Listings and Bookings sections (keeping existing code) */}
        ...
        {/* Impact Section (keeping existing code) */}
